...
function ProductDetails() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-[#fcfbf8]">
        ...
        {/* LOADING */}
        <div className="flex min-h-screen items-center justify-center pt-[64px]">
  ...
  if (isError || !product) {
    return (
      <div className="min-h-screen bg-[#fcfbf8]">
        ...
        {/* ERROR */}
        <div className="flex min-h-screen flex-col items-center justify-center pt-[64px]">
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="px-5 pb-10 pt-[88px] md:px-8 lg:px-10">
